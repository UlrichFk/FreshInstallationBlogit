...
Route::middleware('admin-language:web')->group(function () {
    ...
    Route::middleware(['permission','check.app.installation','check.app.code_verified'])->group(function () {  
        Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
            ...
            Route::get('/update-short-video-comment-column/{id}/{name}/{value}', 'App\Http\Controllers\Admin\ShortVideoController@updateShortVideoColumn');
            Route::post('/update-short-video-comment', 'App\Http\Controllers\Admin\ShortVideoController@updateShortVideoComment');
            ...
            Route::post('/update-comment', 'App\Http\Controllers\Admin\BlogController@updateComment');
            Route::delete('/delete-comment/{id}', 'App\Http\Controllers\Admin\BlogController@destroyComment');
            Route::get('/update-comment-column/{id}/{name}/{value}', 'App\Http\Controllers\Admin\BlogController@updateColumn');
            Route::delete('/delete-selected', 'App\Http\Controllers\Admin\BlogController@deleteSelected')->name('deleteSelected');
            ...
            /************************* Search Routings Ends Here **************************/


            /************************* COntact Us Routing Starts Here **************************/
            
            Route::get('/contact-us', 'App\Http\Controllers\Admin\ContactUsController@index');
            Route::post('/contact-us', 'App\Http\Controllers\Admin\ContactUsController@index');
            Route::post('/contact-us-reply', 'App\Http\Controllers\Admin\ContactUsController@replyQuery');
            
            /************************* COntact Us Routing Ends Here **************************/
             ...
             /******************** Rss Feeds Items Routing Starts Here *******************/
             ...
             /************************* Rss Feeds Items Routing Ends Here **************************/
             
             
            /************************* Management Routing Starts Here **************************/
            Route::get('/app-home-page', 'App\Http\Controllers\Admin\AppHomePageController@index');
            Route::get('/create-app-home-page', 'App\Http\Controllers\Admin\AppHomePageController@create');
            Route::post('/add-app-home-page', 'App\Http\Controllers\Admin\AppHomePageController@store');
            Route::get('/edit-app-home-page/{id}', 'App\Http\Controllers\Admin\AppHomePageController@edit');
            Route::post('/update-app-home-page', 'App\Http\Controllers\Admin\AppHomePageController@update');
            Route::delete('/delete-app-home-page/{id}', 'App\Http\Controllers\Admin\AppHomePageController@destroy');
            Route::get('/update-app-home-page-status/{id}/{value}', 'App\Http\Controllers\Admin\AppHomePageController@changeStatus');
            Route::get('/app-home-page/translation/{id}', 'App\Http\Controllers\Admin\AppHomePageController@translation');
            Route::post('/app-home-page/translation/{id}', 'App\Http\Controllers\Admin\AppHomePageController@updateTranslation');
            Route::post('/app-home-page-sortable','App\Http\Controllers\Admin\AppHomePageController@sorting');
            /************************* Management Routing Ends Here **************************/
