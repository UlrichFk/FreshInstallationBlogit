    ...
    public function up(): void
    {
        if (!Schema::hasTable('blog_analytics')) {
            Schema::create('blog_analytics', function (Blueprint $table) {
                $table->id();
                $table->enum('type', ['view','share','poll_share','blog_time_spent','app_time_spent','like','share_twitter','share_telegram','share_whatsapp','share_mail','blog_poll_option'])->default('view');
