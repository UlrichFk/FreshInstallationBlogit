...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $tempArr = array(
            ...
            array('module' => 'Membership Plans','route_name' => 'membership-plans','permission_name' => 'List','group' => 'membership-plans','is_default' => 0),
            array('module' => 'Membership Plans','route_name' => 'add-membership-plan','permission_name' => 'Add','group' => 'membership-plans','is_default' => 0),
            array('module' => 'Membership Plans','route_name' => 'update-membership-plan','permission_name' => 'Update','group' => 'membership-plans','is_default' => 0),
            array('module' => 'Membership Plans','route_name' => 'update-membership-plan-status','permission_name' => 'Status Change','group' => 'membership-plans','is_default' => 0),
            array('module' => 'Membership Plans','route_name' => 'delete-membership-plan','permission_name' => 'Delete','group' => 'membership-plans','is_default' => 0),
            array('module' => 'User Subscriptions','route_name' => 'user-subscriptions','permission_name' => 'List','group' => 'user-subscriptions','is_default' => 0),
            array('module' => 'User Subscriptions','route_name' => 'add-user-subscription','permission_name' => 'Add','group' => 'user-subscriptions','is_default' => 0),
            array('module' => 'User Subscriptions','route_name' => 'update-user-subscription','permission_name' => 'Update','group' => 'user-subscriptions','is_default' => 0),
            array('module' => 'User Subscriptions','route_name' => 'show-user-subscription','permission_name' => 'Show','group' => 'user-subscriptions','is_default' => 0),
            array('module' => 'User Subscriptions','route_name' => 'delete-user-subscription','permission_name' => 'Delete','group' => 'user-subscriptions','is_default' => 0),
            array('module' => 'User Subscriptions','route_name' => 'cancel-user-subscription','permission_name' => 'Cancel','group' => 'user-subscriptions','is_default' => 0),
            array('module' => 'User Subscriptions','route_name' => 'renew-user-subscription','permission_name' => 'Renew','group' => 'user-subscriptions','is_default' => 0),
        ...
        Permission::where('permission_name','translation-by-third-party')->delete();
        Permission::where('permission_name','Setting')->update(['permission_name' => 'List']);
