    ...
    */
    public function analytics(Request $request,$id)
    {
        try{
            ...
            $data['views'] = AdAnalytic::where('type','view')->where('ad_id',$id)->with('user')->paginate($pagination)->appends('perpage', $pagination);
            $data['overAllViews'] = AdAnalytic::where('type','view')->where('ad_id',$id)->with('user')->groupBy('user_id')->paginate($pagination)->appends('perpage', $pagination);
            $data['clicks'] = AdAnalytic::where('type','click')->where('ad_id',$id)->with('user')->paginate($pagination)->appends('perpage', $pagination);
