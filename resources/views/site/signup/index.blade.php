				...
				<div class="container">
					<div class="contact-info">
						<div class="block-title">
							<h3>{{__('lang.website_signup_title')}}</h3>
						</div>
					</div>
					<div class="contact-form">
						<form class="row" id="user-signup"  onsubmit="return validateAlphabeticName() && validateEmail() && validatePhoneNumber() && validatePassword();" action="{{url('/do-user-signup')}}" method="POST">
							  @csrf
							  <div class="col-md-12 form-group" style="text-align: -webkit-center;">
						        ...
						        <div class="col-md-4 form-group" style="text-align: left;width: 100%;margin-bottom: 2rem;">
									<a href="{{url('/login')}}" style="float:left;">{{__('lang.website_signin_title')}}</a>
								</div>
							    <div class="col-md-4 form-group">
							      <button type="submit" class="submit">{{__('lang.website_signup_button')}}</button>
							    </div>
							  </div>
							</form>
					</div>
