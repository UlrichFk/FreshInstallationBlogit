                    ...
                    <div class="search_header_menu">
                        ...
                        <ul class="social_icon_header_top jl_socialcolor">
                            ...
                            @if(isset($getSocialMediaForSite) && count($getSocialMediaForSite)< 3)
                                ...
                                <li>
                                    <a href="{{$getSocialMediaForSite[$i]->url}}"  target="_blank"><i class="fa {{$getSocialMediaForSite[$i]->icon}}" style="color:{{$getSocialMediaForSite[$i]->icon_background_color}} !important"></i></a>
                                </li>
                                @endfor
                            @endif
                        </ul>
