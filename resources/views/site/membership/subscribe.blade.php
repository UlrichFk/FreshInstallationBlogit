...
@section('title', 'S\'abonner à ' . $plan->name)
                ...
                <div class="col-lg-10 text-center">
                    <div class="hero-content">
                        <div class="hero-badge">
                            ...
                            <span>{{ __('lang.site_premium_plan') }}</span>
                        </div>
                        <h1 class="hero-title">
                            {{ __('lang.site_unlock_premium_access') }}<span class="highlight">{{ __('lang.site_premium_access') }}</span>
                        </h1>
                        <p class="hero-subtitle">
                            {{ __('lang.site_join_exclusive_community') }}
                        </p>
                        <div class="hero-stats">
                            <div class="stat-item">
                                <div class="stat-number">10K+</div>
                                <div class="stat-label">{{ __('lang.site_active_members') }}</div>
                            </div>
                            <div class="stat-divider"></div>
                            <div class="stat-item">
                                <div class="stat-number">24/7</div>
                                <div class="stat-label">{{ __('lang.site_support') }}</div>
                            </div>
                            <div class="stat-divider"></div>
                            <div class="stat-item">
                                <div class="stat-number">99%</div>
                                <div class="stat-label">{{ __('lang.site_satisfaction') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="plan-summary-card">
                                    <div class="plan-header">
                                        ...
                                        <h3>{{ $plan->name }}</h3>
                                        <p class="plan-description">{{ $plan->description ?? __('lang.site_complete_premium_access') }} {{ __('lang.site_with_exclusive_features') }}</p>
                                    </div>
                                    ...
                                    <div class="plan-pricing">
                                        ...
                                        <div class="price-note">{{ __('lang.site_automatic_billing') }}</div>
                                    </div>
                                    
                                    @if($plan->features && is_array($plan->features))
                                    <div class="plan-features">
                                        <h4>{{ __('lang.site_included_features') }}</h4>
                                        <ul>
                                    ...
                                    <div class="plan-features">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <span>{{ __("lang.site_access_all_premium_content") }}</span>
                                            </li>
                                            <li>
                                                <div class="feature-icon">
                                                    <i class="ti ti-check"></i>
                                                </div>
                                                <span>{{ __('lang.site_exclusive_premium_content') }}</span>
                                            </li>
                                            <li>
                                                <div class="feature-icon">
                                                    <i class="ti ti-check"></i>
                                                </div>
                                                <span>{{ __('lang.site_priority_support') }}</span>
                                            </li>
                                            <li>
                                                <div class="feature-icon">
                                                    <i class="ti ti-check"></i>
                                                </div>
                                                <span>{{ __('lang.site_no_ads') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                    @endif
                                    ...
                                    <div class="plan-footer">
                                        <div class="security-badge">
                                            <i class="ti ti-shield-check"></i>
                                                <span>{{ __('lang.site_secure_payment') }}</span>
                                        </div>
                                        <div class="guarantee-badge">
                                            <i class="ti ti-refresh"></i>
                                            <span>{{ __('lang.site_30_days_satisfaction_guarantee') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8">
                                <div class="payment-form-card">
                                    <div class="card-header">
                                        ...
                                        <h3>{{ __('lang.site_finalize_subscription') }}</h3>
                                        <p>{{ __("lang.site_fill_info_access_premium") }}</p>
                                    </div>
                                    
                                    <form id="subscriptionForm" action="{{ url('payment/stripe/subscription') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="plan_id" value="{{ $plan->id }}">
                                        <input type="hidden" name="amount" value="{{ $plan->price }}">
                                        <input type="hidden" name="currency" value="{{ $plan->currency ?? 'EUR' }}">
                                                ...
                                                <div class="col-12 d-flex gap-4 flex-wrap">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="gateway_stripe">
                                                            <i class="ti ti-brand-stripe me-1"></i> {{ __('lang.site_card') }} (Stripe)
                                                        </label>
                                                    </div>
                                                    @endif
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-wrapper">
                                                            ...
                                                            <input type="text" class="form-control @error('card_number') is-invalid @enderror card-number" 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="cvv" class="form-label">
                                                            {{ __('lang.site_cvv') }} <span class="required">*</span>
                                                        </label>
                                                        <div class="input-wrapper">
                                        ...
                                        <div class="form-section">
                                            <div class="section-header">
                                                ...
                                                <h4>{{ __('lang.site_subscription_options') }}</h4>
                                            </div>
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    <div class="form-check custom-checkbox">
                                                        ...
                                                        <label class="form-check-label" for="auto_renew">
                                                            {{ __('lang.site_automatic_subscription_renewal') }}
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-check custom-checkbox">
                                                        ...
                                                        <label class="form-check-label" for="terms">
                                                            {{ __('lang.site_accept_terms_and_privacy') }}
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-primary btn-subscribe" id="pay-button">
                                                <div class="btn-content">
                                                    <i class="ti ti-rocket"></i>
                                                    <span>{{ __('lang.site_pay_and_subscribe') }}</span>
                                                </div>
                                            ...
                                            <div class="action-note">
                                                ...
                                                <span>{{ __('lang.site_subscription_active_immediately') }}</span>
                                            </div>
                                        </div>
                                    </form>
                                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h3>{{ __('lang.site_why_trust_us') }}</h3>
                    <div class="trust-grid">
                        <div class="trust-item">
                            <div class="trust-icon">
                                <i class="ti ti-shield-check"></i>
                            </div>
                            <h4>{{ __('lang.site_security') }}</h4>
                            <p>{{ __('lang.site_encrypted_and_secure_payments') }}</p>
                        </div>
                        <div class="trust-item">
                            <div class="trust-icon">
                                <i class="ti ti-headset"></i>
                            </div>
                            <h4>{{ __('lang.site_support') }}</h4>
                            <p>{{ __('lang.site_24_7_support_available') }}</p>
                        </div>
                        <div class="trust-item">
                            <div class="trust-icon">
                                <i class="ti ti-refresh"></i>
                            </div>
                            <h4>{{ __('lang.site_guarantee') }}</h4>
                            <p>{{ __('lang.site_30_days_satisfaction_guarantee') }}</p>
                        </div>
                    </div>
                </div>
            </div>
...
.hero-section::before {
    ...
    right: 0;
    bottom: 0;
    background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="heroPattern" width="100" height="100" patternUnits="userSpaceOnUse"><circle cx="25" cy="25" r="1" fill="rgba(255,255,255,0.1)"/><circle cx="75" cy="75" r="1" fill="rgba(255,255,255,0.1)"/><circle cx="50" cy="10" r="0.5" fill="rgba(255,255,255,0.1)"/></pattern></defs><rect width="100" height="100" fill="url(%23heroPattern)"/></svg>');
    opacity: 0.3;
}
...
.subscription-form-section::before {
    content: '';
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
    height: 100px;
    background: linear-gradient(to bottom, var(--gradient-primary), transparent);
}
...
.security-badge, .guarantee-badge {
    display: flex;
    align-items: center;
    justify-content: center;
    gap: 0.75rem;
...
.security-badge i, .guarantee-badge i {
...
@media (max-width: 576px) {
    ...
    /* Amélioration des checkboxes sur mobile */
    .form-check-input {
        width: 20px;
        height: 20px;
        margin-top: 0.125rem;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function applyGateway(gateway) {
        if (gateway === 'paypal') {
            form.action = '{{ url('payment/paypal/subscription') }};
            paymentMethodInput.value = 'paypal';
            if (cardSection) cardSection.style.display = 'none';
            payButton.querySelector('span').textContent = 'Continuer vers PayPal';
        } else {
            form.action = '{{ url('payment/stripe/subscription') }};
            paymentMethodInput.value = 'stripe';
            if (cardSection) cardSection.style.display = 'block';
            payButton.querySelector('span').textContent = "{{ __('lang.site_subscribe_now') }}";
        }
    }
