    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{(Request::is('admin/settings*') || Request::is('admin/social-media*') || Request::is('admin/watermark*')) ? 'active open' : ''}} ">
            ...
            <ul class="menu-sub">
                ...
                @endcan
                @can('settings')
                <li class="menu-item {{Request::is('admin/app-home-page*') ? 'active' : ''}}">
                    <a href="{{url('admin/app-home-page')}}" class="menu-link">
                    <div data-i18n="{{__('lang.admin_app_home_page_management')}}">{{__('lang.admin_app_home_page_management')}}</div>
                    </a>
                </li>
                @endcan
            </ul>
