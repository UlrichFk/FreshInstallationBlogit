      ...
      <form class="add-new-record pt-0 row g-2" id="add-record" onsubmit="return validateSubadmin('add-record');" action="{{url('admin/add-sub-admin')}}" method="POST" enctype="multipart/form-data"> @csrf 
        ...
        <div class="col-sm-12">
          <div class="mb-1">
            ...
            <div class="d-flex-p">
              <img src="" class="rounded me-50 image-preview-cls" id="image-preview" alt="photo" height="80" width="80" onerror="this.onerror=null;this.src=`{{ asset('uploads/image_preview.jpg') }}`"/>
              <div class="img-footer">
                <label class="btn btn-primary me-75 mb-0" for="change-picture">
                  ...
                  <input class="form-control" type="file" id="change-picture" hidden accept="image/*" name="photo" onclick="showImagePreview('change-picture','image-preview',512,512);"/>
                  <span class="d-block d-sm-none">
                    <i class="me-0" data-feather="edit"></i>
                  </span>
                </label>
                <p class="img-label"></p>
                <p class="img-resolution">{{__('lang.admin_subadmin_image_resolution')}}</p>
              </div>
            </div>
          </div>
        </div>
