                                ...
                                <form class="add-new-record pt-0 row g-2" id="edit-record_{{$row->id}}" action="{{url('admin/update-sub-admin')}}" method="POST" enctype="multipart/form-data" > @csrf 
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-1">
                                            ...
                                            <div class="d-flex-p">
                                                <img src="{{ url('uploads/user/'.$row->photo)}}" class="rounded me-50 image-preview-cls" id="image-preview" alt="photo" height="80" width="80" onerror="this.onerror=null;this.src=`{{ asset('uploads/image_preview.jpg') }}`"/>
