...
@foreach($result as $row)
    ...
    <div class="col-md-6 mb-3">
        ...
        <textarea type="text" class="form-control" name="google_analytics_code" value="{{$row->value}}" placeholder="{{__('lang.admin_google_analytics_code_placeholder')}}" row="1">{{$row->value}}</textarea>
    </div>
    @endif 
@endforeach
@foreach($result as $row)
    ...
    <div class="col-md-12 mb-3">
        ...
        <input type="text" class="form-control" name="news_api_key" value="{{ \Helpers::maskApiKey($row->value)}}" placeholder="{{__('lang.admin_news_api_key_placeholder')}}">
    </div>
    @endif
    ...
    <div class="col-md-4 mb-3">
        <div class="d-flex-p">
            ...
            <div class="img-footer">
                ...
                <p class="img-label">{{__('lang.admin_website_favicon_resolution')}}</p>
                <p class="img-resolution">{{__('lang.admin_website_favicon')}}</p>
            </div>
        </div>
    </div>
    @endif
