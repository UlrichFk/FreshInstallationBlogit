...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="offcanvas offcanvas-end" id="add-new-record">
    ...
    <div class="offcanvas-body flex-grow-1">
      <form class="add-new-record pt-0 row g-2" id="add-record" onsubmit="return validateLiveNews('add-record');" action="{{url('admin/add-live-news')}}" method="POST" enctype="multipart/form-data"> 
        @csrf 
        <div class="col-sm-12">
          <div class="mb-1">
