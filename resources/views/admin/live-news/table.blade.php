                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <form id="deleteForm_{{$row->id}}" onsubmit="return deleteConfirm('deleteForm_{{$row->id}}');" action="{{ url('admin/delete-live-news', $row->id) }}" method="POST"> @csrf @method('DELETE') <button type="submit" class="dropdown-item" data-toggle="tooltip" data-placement="bottom" title="{{ __("lang.admin_delete") }}">
                            ...
                            <div class="offcanvas-body flex-grow-1">
                                <form class="add-new-record pt-0 row g-2" id="edit-record" action="{{url('admin/update-live-news')}}" method="POST" enctype="multipart/form-data" onsubmit="return validateCategory();"> @csrf 
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="d-flex-p">
                                            <img src="{{ asset('uploads/live-news')}}/{{$row->image}}" id="image-preview_{{$row->id}}" class="rounded me-50 image-preview-cls" alt="profile image" height="80" width="80" onerror="this.onerror=null;this.src=`{{ asset('uploads/image_preview.jpg') }}`" />
