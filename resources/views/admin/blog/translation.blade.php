                            ...
                            <div class="row formbody <?php if($i>0){ ?>hide<?php } ?>" id="translation_{{$row->code}}">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3 display-inline-block width-74-percent">
                                        ...
                                        <input class="form-control tags" value="{{$row->details->tags}}" name="tags[]" placeholder="{{__('lang.admin_tags')}}" onkeypress="setValue('seo_tag',this.value);" />
                                    </div>
                                </div>
                                @endif -->
                                <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3 display-inline-block width-74-percent">
                                        ...
                                        <input type="text" class="form-control seo_tag" placeholder="{{__('lang.admin_seo_tag')}}" value="{{$row->details->seo_tag}}" name="seo_tag[]" />
                                    </div>
                                </div>
                                @endif -->
                                @if($detail->type=='post')
