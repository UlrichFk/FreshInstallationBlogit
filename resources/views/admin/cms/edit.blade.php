                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-sm-12">
                                <div class="mb-1">
                                    ...
                                    <div class="d-flex">
                                    <img src="{{ asset('uploads/cms')}}/{{$row->image}}" id="image-preview" class="rounded me-50" alt="profile image" height="80" width="80" onerror="this.onerror=null;this.src=`{{ asset('uploads/no-image.png') }}`" />
