                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <form id="deleteForm_{{$row->id}}" onsubmit="return deleteConfirm('deleteForm_{{$row->id}}');" action="{{ url('admin/delete-visibility', $row->id) }}" method="POST"> @csrf @method('DELETE') <button type="submit" class="dropdown-item" data-toggle="tooltip" data-placement="bottom" title="{{ __("lang.admin_delete") }}">
                                ...
                                <form class="add-new-record pt-0 row g-2" id="edit-record" action="{{url('admin/update-visibility')}}" method="POST" enctype="multipart/form-data" onsubmit="return validateVisibility();"> @csrf 
                                    <div class="col-sm-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-full-name" id="display_name" placeholder="{{__('lang.admin_name_placeholder')}}" name="display_name" value="{{$row->display_name}}" required>
                                        </div>
                                    </div>
                                    <!--<div class="col-sm-12">-->
