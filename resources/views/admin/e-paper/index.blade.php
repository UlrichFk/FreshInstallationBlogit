@extends('admin/layout/app') @section('content') <div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="offcanvas offcanvas-end" id="add-new-record">
    ...
    <div class="offcanvas-body flex-grow-1">
      <form class="add-new-record pt-0 row g-2" id="add-record" onsubmit="return validateEpaper('add-record');" action="{{url('admin/add-e-paper')}}" method="POST" enctype="multipart/form-data"> 
        @csrf 
        <div class="col-sm-12">
          <div class="mb-1">
        ...
        <div class="col-sm-12">
          <div class="mb-1">
            ...
            <div class="d-flex-p">
              <iframe src="" class="rounded me-50 hide image-preview-cls" id="pdf-preview" alt="image" height="80" width="80"></iframe>
              <div class="img-footer">
                <label class="btn btn-primary me-75 mb-0" for="change-pdf">
                  ...
                  <input class="form-control" type="file" name="pdf" id="change-pdf" hidden accept=".pdf" name="pdf" onchange="showPdfPreview(this, 'pdf-preview');" required/>
        ...
        <div class="col-sm-12">
          <div class="mb-1">
            ...
            <div class="d-flex-p">
              <img src="" class="rounded me-50 image-preview-cls" id="image-preview" alt="image" height="80" width="80"  onerror="this.onerror=null;this.src=`{{ asset('uploads/image_preview.jpg') }}`"/>
              <div class="img-footer">
                <label class="btn btn-primary me-75 mb-0" for="change-picture">
                  <span class="d-none d-sm-block"><i class="tf-icons ti ti-upload"></i></span>
                  <input class="form-control" type="file" name="image" id="change-picture" hidden accept="image/png, image/jpeg, image/jpg" name="image" onclick="showImagePreview('change-picture','image-preview',512,512);" required/>
                  <span class="d-block d-sm-none">
                    <i class="me-0" data-feather="edit"></i>
                  </span>
                </label>
