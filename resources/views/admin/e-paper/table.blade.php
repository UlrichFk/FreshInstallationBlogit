                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                @endcan
                                @can('delete-e-paper')
                                <form id="deleteForm_{{$row->id}}" onsubmit="return deleteConfirm('deleteForm_{{$row->id}}');" action="{{ url('admin/delete-e-paper', $row->id) }}" method="POST"> @csrf @method('DELETE') <button type="submit" class="dropdown-item" data-toggle="tooltip" data-placement="bottom" title="{{ __("lang.admin_delete") }}">
                            ...
                            <div class="offcanvas-body flex-grow-1">
                                <form class="add-new-record pt-0 row g-2" id="edit-record" action="{{url('admin/update-e-paper')}}" method="POST" enctype="multipart/form-data" onsubmit="return validateEpaper();"> @csrf 
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-1">
                                            ...
                                            <div class="d-flex-p">
                                                ...
                                                @else
                                                <iframe src="" class="rounded me-50 mb-2 hide" id="edit-pdf-preview_{{$row->id}} image-preview-cls" alt="image" height="80" width="80"></iframe>
                                                @endif
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="d-flex-p">
                                            <img src="{{ asset('uploads/e-paper')}}/{{$row->image}}" id="image-preview_{{$row->id}}" class="rounded me-50 image-preview-cls" alt="profile image" height="80" width="80" onerror="this.onerror=null;this.src=`{{ asset('uploads/image_preview.jpg') }}`" />
                                            <div class="img-footer">
