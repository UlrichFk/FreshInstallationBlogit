...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4 display-inline-block">
    <span class="text-muted fw-light">
      <a href="{{url('admin/dashboard')}}">{{__('lang.admin_dashboard')}}</a> / </span> {{__('lang.admin_app_home_page')}} {{__('lang.admin_list')}}
  </h4>
  <a class="btn btn-secondary btn-primary float-right mt-3" href="{{url('admin/create-app-home-page')}}">
    <span>
      <i class="ti ti-plus me-md-1"></i>
      <span class="d-md-inline-block d-none">{{__('lang.admin_create_app_home_page')}}</span>
    </span>
  </a>
<div class="card margin-bottom-20">
  ...
  <div class="card">
    <div class="card-header">
      <h5 class="card-title display-inline-block">{{__('lang.admin_app_home_page')}} {{__('lang.admin_list')}}</h5>
    ...
    <div class="table-responsive"> @include('admin/app-home-page/table') </div>
