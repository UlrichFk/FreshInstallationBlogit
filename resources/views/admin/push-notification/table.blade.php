        ...
        @if(count($result) > 0) 
            @foreach($result as $row) 
                ...
                <tr>
                    ...
                    <td> 
                       <img src="{{ url('uploads/push-notification/'.$row->image)}}" class="me-75" height="50" width="50" alt="{{$row->name}}" onerror="this.onerror=null;this.src=`{{ asset('uploads/no-image.png') }}`" />
                    </td>
                    <td>
