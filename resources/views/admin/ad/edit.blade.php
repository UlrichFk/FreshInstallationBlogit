                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                        ...
                        <div class="col-md-12 showImage @if($row->media_type=='video' || $row->media_type=='video_url') hide @endif" style="margin-top: 15px;">
                            ...
                            <img src="{{url('uploads/ad/'.$row->media)}}" class="rounded me-50 @if($row->media=='') hide @endif image-preview-cls" id="image-preview" alt="image" height="80" width="80" style="margin-top: 20px;"/>
                        </div>
